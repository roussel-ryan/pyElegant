...
class Beamline(AcceleratorElement):
	...
	def get_element_index(self,element_name):
		"""Finds and returns all the indicies of the BeamlineElement with the name element_name"""
		indicies = []
		for index,ele in zip(xrange(0,len(self.beamline_elements)),self.beamline_elements):
			if ele.name == element_name:
